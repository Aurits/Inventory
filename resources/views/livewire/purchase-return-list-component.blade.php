            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="createpurchasereturn.html" class="btn btn-added">
                        <img src="{{asset('assets/img/icons/plus.svg')}}" alt="img" class="me-2">Add Purchase Return
                    </a>
                </div>
            </div>
                        ...
                        <table class="table datanew">
                            ...
                            @foreach($purchaseReturns as $purchaseReturn)
                                <tr>
                                    ...
                                    <td>{{$purchaseReturn->supplierName}} </td>
                                    ...
                                    <td>{{$purchaseReturn->due}}</td>
                                    <td><span class="badges bg-lightgreen">{{$purchaseReturn->paymentStatus}}</span></td>
                                    <td>
