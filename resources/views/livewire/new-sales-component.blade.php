...
<ul>
<li>
<a href="javascript:void(0);" class="deletebg confirm-text"><img src="{{asset('assets/img/icons/delete-2.svg')}}" alt="img"></a>
</li>
<li>
...
<div class="col-12">
<div class="text-end">
<a class="btn btn-scanner-set"><img src="{{asset('assets/img/icons/scanner1.svg')}}" alt="img" class="me-2">Scan bardcode</a>
</div>
</div>
</div>
</div>
...
<li>3000.00	</li>
<li><a class="confirm-text" href="javascript:void(0);"><img src="{{asset('assets/img/icons/delete-2.svg')}}" alt="img"></a></li>
</ul>
<ul class="product-lists">
<li>
<div class="productimg">
...
<ul>
<li>
<a class="btn"><img src="{{asset('assets/img/icons/pause1.svg')}}" alt="img" class="me-1">Hold</a>
</li>
<li>
<a class="btn"><img src="{{asset('assets/img/icons/edit-6.svg')}}" alt="img" class="me-1">Quotation</a>
</li>
<li>
<a class="btn"><img src="{{asset('assets/img/icons/trash12.svg')}}" alt="img" class="me-1">Void</a>
</li>
<li>
<a class="btn"><img src="{{asset('assets/img/icons/wallet1.svg')}}" alt="img" class="me-1">Payment</a>
</li>
<li>
<a class="btn" data-bs-toggle="modal" data-bs-target="#recents"><img src="{{asset('assets/img/icons/transcation.svg')}}" alt="img" class="me-1"> Transaction</a>
</li>
</ul>
</div>
</div>
...
<li>
<a href="javascript:void(0);" class="btn btn-closes"><img src="{{asset('assets/img/icons/close-circle.svg')}}" alt="img"></a>
</li>
<li>
<a href="javascript:void(0);">0</a>
</li>
<li>
<a href="javascript:void(0);" class="btn btn-reverse"><img src="{{asset('assets/img/icons/reverse.svg')}}" alt="img"></a>
</li>
</ul>
</div>
</div>
