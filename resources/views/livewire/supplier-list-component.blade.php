    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="addsupplier.html" class="btn btn-added"><img src="{{asset('assets/img/icons/plus.svg')}}" alt="img">Add Supplier</a>
                </div>
            </div>
                            ...
                            @foreach($suppliers as $supplier)
                                <tr>
                                    ...
                                    <td class="productimgname">
                                        ...
                                        <a href="javascript:void(0);">{{$supplier->supplierName}}</a>
                                    </td>
