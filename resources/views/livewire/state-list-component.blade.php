    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="newstate.html" class="btn btn-added"><img src="{{asset('assets/img/icons/plus.svg')}}" alt="img" class="me-2">Add State</a>
                </div>
            </div>
                        ...
                        <table class="table  datanew">
                            ...
                            @foreach($states as $state)
                                <tr>
                                    ...
                                    <td><span class="badges bg-lightgreen">{{$state->status}}</span></td>
