    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="addstore.html" class="btn btn-added"><img src="{{asset('assets/img/icons/plus.svg')}}" alt="img" class="me-2">Add Store</a>
                </div>
            </div>
                        ...
                        <table class="table  datanew">
                            ...
                            @foreach($stores as $store)
                                <tr>
                                    ...
                                    <td>{{$store->phone}}</td>
                                    <td>{{$store->email}}</a></td>
                                    <td><span class="badges bg-lightgreen">{{$store->status}}</span></td>
                                    <td class="d-flex">
