            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="text-center fw-bold p-4">
                        ...
                        <div>
                            @auth
                            <h4><a href="{{ url('/dashboard') }}" class="text-center fw-bold p-4 ">Dashboard</a></h4>
                            @else
                            <h4><a href="{{ route('login') }}" class="text-center fw-bold p-4 ">Log in</a></h4>

                            @if (Route::has('register'))
                            <h4> <a href="{{ route('register') }}" class="text-center fw-bold p-4 ">Register</a></h4>
                            @endif
                            @endauth
                        </div>
                        @endif
                    ...
                    <div class="col-lg-8 col-sm-12 tabs_wrapper">
                        <div class="page-header ">
                            <div class="page-title">
                                <h4>INVENT STORE</h4>
                                <h6>Manage your purchases with ease</h6>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-12 ">
                        ...
                        <div class="card card-order">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <a href="javascript:void(0);" class="btn btn-adds" data-bs-toggle="modal" data-bs-target="#create"><i class="fa fa-plus me-2"></i>INVENT STORE</a>
                                    </div>
                                    <div class="col-lg-12">
